...
const port = process.env.SERVER_PORT || process.env.PORT || 7749;        
const UUID = process.env.UUID || '9d06ac81-3a87-4bbb-ac6c-53d7fc980ece'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo0815.nre4.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjczNmMwM2M5Yjk3MDdlMWU2N2I4ODExMWU2OWViZjMiLCJ0IjoiMzRlYTMzYTEtZmI1Zi00YTZhLTlmYWEtMTA1MjY2ZGMxNjE2IiwicyI6Ik5ESmpNek5tTWpNdE1UUmxNaTAwTkdRNUxUazFPRE10T0dZMVptRTJZakk0T1RCaSJ9';
